...
public class FuncionarioTest {
	...
	@Test
	public void testSalarioDesenvolvedorMenorQue3Mil() throws Exception {
		funcionario.setSalario(2800.00);
		Assert.assertEquals(2520.00, funcionario.calculaSalario(), 0.0);
	}

	@Test
	public void testSalarioDBA2MilOuMais() throws Exception {
	...
	@Test
	public void testSalarioDBAMenorQue2Mil() throws Exception {
		funcionario.setCargo(new DBA());
	...
	@Test
	public void testSalarioTestadorMenorQue2Mil() throws Exception {
		funcionario.setCargo(new Testador());
	...
	@Test
	public void testSalarioGerente5MilOuMais() throws Exception {
